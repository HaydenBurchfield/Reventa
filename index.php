...
<title>THRIFT — Buy & Sell Fashion</title>
...
<nav id="top-nav">
  <div class="nav-logo">THRIFT<span>.</span></div>
...
<main id="app">
  <div class="hero">
    <div class="hero-text">
      ...
      <div class="hero-ctas">
        <a href="explore.php"><button class="btn-primary">Start Shopping</button></a>
        <a href="sell.php"><button class="btn-ghost">List an Item</button></a>
      </div>
    </div>
  </div>
  ...
  <div class="section-header"><h2>Trending Now</h2><a href="explore.php">View all →</a></div>
