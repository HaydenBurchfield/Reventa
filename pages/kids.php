...
// Find the Kids category id dynamically
$catObj    = new Category();
$allCats   = $catObj->getAllCategories();
$menCatId  = null;
foreach ($allCats as $c) {
    if (stripos($c->name, 'kid') !== false) {
        $menCatId = $c->id;
        break;
    }
}
...
const menu = document.getElementById('navMobileKidsu');
