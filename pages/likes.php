...
<title>THRIFT — Liked Items</title>
...
<main id="app">
  <div class="section-header" style="padding-top:2rem">
    <h2>Liked Items</h2>
    <span class="likes-count" id="likes-count">0 items</span>
  </div>
  <div class="product-grid" id="likes-grid"></div>
</main>
...
<nav id="bottom-nav">
  ...
  <a class="bottom-item active" href="likes.php"><div class="bottom-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></div><div class="bottom-label">Likes</div></a>
